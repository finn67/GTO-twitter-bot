...
def Twitter(videotime,Videoselectvar2,seconds):
    auth = tweepy.OAuthHandler("aowxgUMFvZywLFZnngnbN62ir", "ZonRpQYFfXfm3YLiWwYS71xUp5P4Usmdz1wt1nFMZnW66ckg0g")
    auth.set_access_token("1603225031345147904-1osIwaCoPJGabTSFxX2yCBHQ1loWF1", "BqpqHPbaAhVk08gwinN25KTvaUn34r5h1hgTyho7xTltc")
    api = tweepy.API(auth)
...
#to do list : fix var names/ tidy, figure out aws storage stuff(lambda, glue, trim down file sizes)
